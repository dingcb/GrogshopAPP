...
public class DataServer {
    ...
    public static List<Status> getSampleData(int lenth) {
        ...
        for (int i = 0; i < lenth; i++) {
            ...
            status.setUserName("房山区京周路与拱辰北大街交汇处LED广告屏" + i);
            status.setCreatedAt("该媒体位于京周路与拱辰大街交汇处，距京港澳高速机场收费站（良乡）出口500米，北邻房山区政府，南邻房山商业中心，地理位置优越，有较高的人流量，车流量；广告面积较大，广告效果显著。周边商场林立，居民集中，显示屏所处位置人口高度密集，车水马龙，热闹非凡。媒体周边的高端商业消费人群、商旅人士及旅游观光人群；有较高的受众人群注意率，地理位置绝佳，瞬间传达，被动受众。媒体离地高度约15m，周围无干扰，视觉冲击力强。是各企业想要短期内打造知名度的首选高性价比黄金LED媒体。" );
            status.setRetweet(i % 2 == 0);
            status.setUserAvatar("https://avatars1.githubusercontent.com/u/7698209?v=3&s=460");
            status.setText("北京市  房山区");
            list.add(status);
        }
        return list;
    }
